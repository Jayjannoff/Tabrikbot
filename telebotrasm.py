...
import telegram
bot = telegram.Bot(token='5095658818:AAEDLjieBp5P0iDQHVzG52SBpmFXI0Zy0M4',)
...
def start(update: Update, context: CallbackContext) -> int:
    ...
    try:
        update.message.reply_text(
            ...
            "Siz menga o\'zingizni ismingizni jo'natsangiz men sizga 🎊tabrik yasab beraman.",
            reply_markup=markup,
        )
...
def regular_choice(update: Update, context: CallbackContext) -> int:
    ...
    update.message.reply_text(f'Ismingizni jonating!')
    return TYPING_REPLY
...
def received_information(update: Update, context: CallbackContext) -> int:
    ...
    update.message.reply_text(
    f"Sizning ismingiz: {facts_to_str(user_data).title()}✅\n"
...
def done(update: Update, context: CallbackContext) -> int:
    ...
    update.message.reply_text(
        f"Ushbu ism asosida tabrik: {facts_to_str(user_data)} !",
...
#    print('You talk with user {} and his user ID: {}'.format(user['username'], user['id']))
    ...
    try:
        ...
        pic = random.choice([Image.open('renamedpictureone1.jpg'),Image.open('renamedpicturetwo2.jpg')])
...
def main() -> None:
    ...
    updater = Updater("5095658818:AAEDLjieBp5P0iDQHVzG52SBpmFXI0Zy0M4",use_context=True                                                     )
